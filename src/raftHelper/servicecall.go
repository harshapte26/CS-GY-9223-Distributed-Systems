...
/*
	Raft example starts 3 raft nodes.


	Below code uses the curl command to encode and decode key value pairs:
	Encode -> eg: curl -L http://127.0.0.1:12380/my-key -XPUT -d hello
	and Decode -> curl -L http://127.0.0.1:12380/my-key

	Reference Document: https://mholt.github.io/curl-to-go/ & https://www.codershood.info/2017/06/25/http-curl-request-golang/
*/
